...
<?php
	...
	$traveltour_admin_option->add_element(array(
		...
		'options' => array(
			...
			'privacy' => array(
				'title' => esc_html__('Privacy', 'traveltour'),
				'options' => array(
					'disable-cookie-youtube' => array(
						'title' => esc_html__('Disable Cookie On Youtube Videos', 'traveltour'),
						'type' => 'checkbox',
						'default' => 'disable'
					)
				)
			...
			'top-bar-social' => array(
				...
				'options' => array(
                    ...
                    'top-bar-social-phone' => array(
                        'title' => esc_html__('Top Bar Social Phone Link', 'traveltour'),
                        'type' => 'text',
			...
			'title-style' => array(
				...
				'options' => array(
					...
					'default-caption-font-weight' => array(
						...
						'type' => 'text',
						'data-type' => 'text',
						'selector' => '.traveltour-page-title-wrap .traveltour-page-caption{ font-weight: #gdlr#; }',
			...
			'footer' => array(
				...
				'options' => array(
					...
					'footer-bottom-padding' => array(
						...
						'data-type' => 'pixel',
						'default' => '50px',
						'selector' => '.traveltour-footer-wrapper{ padding-bottom: #gdlr#; }',
						'condition' => array( 'enable-footer' => 'enable' )
					),
					'footer-style' => array(
					...
					'copyright-top-padding' => array(
						...
						'data-type' => 'pixel',
						'default' => '38px',
						'selector' => '.traveltour-copyright-text{ padding-top: #gdlr#; }',
						'condition' => array( 'enable-footer' => 'enable' )
					),
					'copyright-bottom-padding' => array(
						...
						'data-type' => 'pixel',
						'default' => '38px',
						'selector' => '.traveltour-copyright-text{ padding-bottom: #gdlr#; }',
						'condition' => array( 'enable-footer' => 'enable' )
					),
