(function($){
		...
		init_slidebar: function(){
			...
			t.main_menu.children('.sf-menu').children('li').hover(function(){
				...
				if( nav_element.length > 0 ){
					t.slide_bar.animate({ width: nav_element.outerWidth() + (2 * t.slide_bar_offset), left: nav_element.position().left - t.slide_bar_offset }, { queue: false, duration: 0 });
				}
			}, function(){
				t.slide_bar.animate({ width: t.slide_bar_val.width, left: t.slide_bar_val.left }, { queue: false, duration: 0 });
			});
				...
				if( sub_menu.length > 0 ){
					if( !sub_menu.hasClass('traveltour-active') ){
						...
						if( prev_active.length > 0 ){
							...
							sub_menu.delay(150).slideToggle(400, 'easeOutQuart').addClass('traveltour-active');
						}else{
							sub_menu.slideToggle(400, 'easeOutQuart').addClass('traveltour-active');
						}
	...
	var traveltour_anchor = function(){
		...
		if( this.anchor_link.length ){
			this.menu_anchor = $('#traveltour-main-menu, #traveltour-bullet-anchor, #tourmaster-content-navigation-item-outer , .gdlr-core-tab-item-title-wrap');
	...
	traveltour_anchor.prototype = {
		...
		animate_anchor: function(){
			...
			t.home_anchor.click(function(){
				...
				if( window.location.href == this.href ){
					$('html, body').animate({ scrollTop: 0 }, { duration: 0, easing: 'easeOutQuart' });
					return false;
				}
		...
		scroll_to: function( hash, redirect, duration ){
			...
			if( typeof(scroll_position) != 'undefined' ){
				...
				$('html, body').animate({ scrollTop: scroll_position }, { duration: 0, easing: 'easeOutQuart', queue: false });
