...
<?php 
	...
	$args = array(
		...
		'fields' => apply_filters('comment_form_default_fields', array(
			'author' =>
				'<div class="comment-form-head"><div class="traveltour-comment-form-author" >' .
			...
			'url' =>
				...
				'" placeholder="' . esc_attr(esc_html__('Website', 'traveltour')) . '" size="30" /><div class="clear"></div></div>',
