<?php 
function wbtm_seat_plan_2($b_start,$date){
	$seat_style = 1;
                ...
                <?php foreach ( $seat_row_arr as $seat_row ) { ?>
                    <tr class="seat<?php echo get_the_id().wbtm_make_id($date); ?>_lists ">
                        ...
                        <td>
                            ...
                            <?php } else { ?> <a data-seat='<?php echo $seat_row.$seat_col; ?>' id='seat<?php echo get_the_id().wbtm_make_id($date); ?>_<?php echo $seat_row.$seat_col; ?>' data-sclass='Economic' class='seat<?php echo get_the_id().wbtm_make_id($date); ?>_blank blank_seat'><?php echo $seat_row.$seat_col; ?></a>
                            <?php } ?>
                        </td>                        
