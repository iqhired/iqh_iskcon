	...
	*/
	...
	if( !function_exists('tourmaster_init_order_page') ){
		function tourmaster_init_order_page(){
			...
			// );
			add_menu_page(
				esc_html__('Booking Transaction', 'tourmaster'),
				esc_html__('Booking Transaction', 'tourmaster'),
				'manage_tour_order',
				'tourmaster_order',
				'tourmaster_create_order_page',
...
//                'departed' => __('Completed', 'tourmaster'),
			...
			fputcsv($fp, array(
                ...
                __('Traveller\'s Detail', 'tourmaster'),
...
//				__('Pending Payment', 'tourmaster'),
			...
			foreach( $results as $result ){
				...
				fputcsv($fp, array(
					...
					getTravellersDetail($traveller_info),
					$contact_info['first_name'] . ' ' . $contact_info['last_name'],
					$contact_info['email'],
                    strval($contact_info['phone']),
...
//                    'departed' => esc_html__('Completed', 'tourmaster'),
