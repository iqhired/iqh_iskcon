		...
		function tourmaster_init_admin_option(){
			if( is_admin() || is_customize_preview() ){
				...
				$tourmaster_option->add_element(array(
					...
					'options' => array(
						...
						'template-settings' => array(
							'title' => esc_html__('Template Settings', 'tourmaster'),
							'options' => array(
								'login-page' => array(
							...
							'options' => array(
								...
								'tour-staff-capability' => array(
									...
									'default' => array(
										...
										'edit_traveller_id', 'read_traveller_id', 'delete_traveller_id',
										'edit_traveller_ids', 'edit_others_traveller_ids', 'publish_traveller_ids', 'read_private_traveller_ids',
										'edit_service', 'read_service', 'delete_service',
										'edit_services', 'edit_others_services', 'publish_services', 'read_private_services',
                                        'edit_seva', 'read_seva', 'delete_seva',
                                        'edit_sevas', 'edit_others_sevas', 'publish_sevas', 'read_private_sevas',
								...
								'tour-author-capability' => array(
									...
									'default' => array(
										...
										'edit_service', 'read_service', 'delete_service',
										'edit_services', 'edit_others_services', 'publish_services', 'read_private_services',
                                        'edit_seva_amt', 'read_seva_amt', 'delete_seva_amt',
                                        'edit_seva_amts', 'edit_others_seva_amts', 'publish_seva_amts', 'read_private_seva_amts',
										'upload_files'
									)
								),
							)
						...
						'payment-page' => array(
							...
							'options' => array(
								...
								'contact-detail-fields' => array(
									...
									'type' => 'textarea',
									'description' => wp_kses(__('Leave blank for default. You can see how to create the fields <a href="http://support.iqhired.com/document/2018/05/01/tourmaster-modifying-the-contact-detail-fields-since-v3-0-8/" target="_blank" >here</a>', 'tourmaster'), array('a'=>array( 'href'=> array(), 'target'=>array())) )
								),
								'additional-traveller-fields' => array(
									'title' => esc_html__('Additional Traveller Fields', 'tourmaster'),
									'type' => 'textarea',
									'description' => wp_kses(__('Use to add new fields at the "traveller details" area. Learn more about this <a href="http://support.iqhired.com/document/2018/05/03/tourmaster-modifying-the-traveller-detail-fields-since-v3-0-8/" target="_blank" >here</a>', 'tourmaster'), array('a'=>array( 'href'=> array(), 'target'=>array())) )
								),
							)
						),
						'archive-page' => array(
						...
						'search-page' => array(
							...
							'options' => array(
								...
								'tour-search-item-style' => array(
									'title' => esc_html__('Tour Search Item Style', 'tourmaster'),
									'type' => 'combobox',
									'options' => array(
								...
								'tour-search-item-thumbnail' => array(
									'title' => esc_html__('Tour Search Item Thumbnail', 'tourmaster'),
									'type' => 'combobox',
									'options' => 'thumbnail-size',
									'default' => 'large',
								),
						...
						'invoice-settings' => array(
							...
							'options' => array(
								...
								'invoice-customer-address' => array(
									...
									'type' => 'textarea',
									'description' => wp_kses(__('Fill this to modify customer address format, if you change the <a href="http://support.iqhired.com/document/2018/05/01/tourmaster-modifying-the-contact-detail-fields-since-v3-0-8/" target="_blank" >contact detail fileds</a>', 'tourmaster'), array('a'=>array( 'href'=> array(), 'target'=>array())) )
								),
							)
						),
						'single-tour' => array(
						...
						'admin-mail-content' => array(
							...
							'options' => array(
								...
								'enable-admin-online-payment-made-mail' => array(
									'title' => esc_html__('Enable Online Payment Made E-Mail', 'tourmaster'),
									'type' => 'checkbox'
								),
								'admin-online-payment-made-mail-title' => array(
									'title' => esc_html__('Online Payment Made E-Mail Title', 'tourmaster'),
									'type' => 'text',
									'condition' => array('enable-admin-online-payment-made-mail' => 'enable')
								),
								'admin-online-payment-made-mail' => array(
									'title' => esc_html__('Online Payment Made E-Mail', 'tourmaster'),
									'type' => 'textarea',
									'wrapper-class' => 'tourmaster-fullsize',
									'condition' => array('enable-admin-online-payment-made-mail' => 'enable')
								),
						...
						'enquiry-mail-content' => array(
							...
							'options' => array(
								...
								'enquiry-form-fields' => array(
									...
									'type' => 'textarea',
									'description' => wp_kses(__('Leave blank for default. You can see how to create the fields <a href="http://support.iqhired.com/document/2017/10/06/tourmaster-modifying-the-enquiry-form/" target="_blank" >here</a>', 'tourmaster'), array('a'=>array( 'href'=> array(), 'target'=>array())) )
								),
				...
				$tourmaster_option->add_element(array(
					...
					'icon' => TOURMASTER_URL . '/images/plugin-options/general.png',
					'options' => apply_filters('iqhired_plugin_payment_option', array(
...
//										'hipayprofessional' => esc_html__('Hipay Professional', 'tourmaster'),
										'instamojo' => esc_html__('Instamojo', 'tourmaster'),
									),
									'default' => array('booking', 'instamojo'),
									'description' => esc_html__('You can use Ctrl/Command button to select multiple items or remove the selected item.', 'tourmaster'),
								),
								...
								'deposit-payment-amount' => array(
									'title' => esc_html__('Deposit Payment Amount (%)', 'tourmaster'),
									'type' => 'text',
									'default' => 0,
									'condition' => array( 'enable-deposit-payment' => 'enable' ),
								...
								'credit-card-payment-gateway' => array(
									...
									'type' => 'combobox',
									'options' => apply_filters('iqhired_credit_card_payment_gateway_options', array('' => esc_html__('None', 'tourmaster')))
								),
...
'.iqhired-payment-form form input.iqhired-payment-button[type="submit"]{ background-color: #gdlr#; }' .
...
'.single-tour .tourmaster-dob-datepicker-wrap:after,' .
							...
							'options' => array(
								'tourmaster-input-form-label' => array(
									...
									'selector' => '.tourmaster-payment-traveller-info-wrap .tourmaster-head, .tourmaster-payment-contact-wrap .tourmaster-head, ' .
										...
										'.iqhired-payment-form .iqhired-payment-form-field .iqhired-payment-field-head{ color: #gdlr#; }',
									'default' => '#5c5c5c',
								),
								'tourmaster-input-box-text' => array(
									...
									'selector' => '.tourmaster-body .tourmaster-form-field input[type="text"], .tourmaster-body .tourmaster-form-field input[type="email"], .tourmaster-body .tourmaster-form-field input[type="password"], ' .
										...
										'.iqhired-payment-form .iqhired-payment-form-field input[type="text"]{ color: #gdlr#; }',
									'default' => '#545454',
								),
								'tourmaster-input-box-background' => array(
									...
									'selector' => '.tourmaster-body .tourmaster-form-field input[type="text"], .tourmaster-body .tourmaster-form-field input[type="email"], .tourmaster-body .tourmaster-form-field input[type="password"], ' .
										...
										'.iqhired-payment-form .iqhired-payment-form-field input[type="text"]{ background-color: #gdlr#; }',
									'default' => '#ffffff',
								),
								...
								'tourmaster-input-box-border' => array(
									...
									'selector' => '.tourmaster-form-field.tourmaster-with-border input[type="text"], .tourmaster-form-field.tourmaster-with-border input[type="email"], ' .
										...
										'.iqhired-payment-form .iqhired-payment-form-field input[type="text"]{ border-color: #gdlr#; }',
									'default' => '#e6e6e6',
								),
                                ...
                                'tourmaster-dob-datepicker-enable-text' => array(
                                ...
                                'tourmaster-dob-datepicker-disable-text' => array(
						...
						'tourmaster-tour-item' => array(
							...
							'options' => array(
								'tour-item-title-color' => array(
									...
									'type' => 'colorpicker',
									'selector' => '.tourmaster-tour-item .tourmaster-tour-title a, .tourmaster-tour-item .tourmaster-tour-title a:hover{ color: #gdlr#; }',
									'default' => '#333333',
								),
								...
								'tour-item-frame-background' => array(
									...
									'type' => 'colorpicker',
									'selector' => '.tourmaster-tour-medium.tourmaster-tour-frame, .tourmaster-tour-full.tourmaster-tour-frame .tourmaster-tour-content-wrap, ' .
						...
						'tourmaster-tour-search-item' => array(
							...
							'options' => array(
								...
								'tourmaster-search-input-border' => array(
									...
									'type' => 'colorpicker',
									'selector' => '.tourmaster-tour-search-wrap .tourmaster-tour-search-field input[type="text"], .tourmaster-tour-search-wrap .tourmaster-tour-search-field select{ border-color: #gdlr#; }',
									'default' => '#676e74',
								),
								...
								'tourmaster-search-filter-text' => array(
									...
									'type' => 'colorpicker',
									'selector' => '.tourmaster-type-filter-term .tourmaster-type-filter-display{ color: #gdlr#; }',
									'default' => '#b0b0b0',
								),
							)
