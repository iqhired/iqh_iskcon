					...
					'settings' => array(
						...
						'options' => array(
							...
							'carousel-navigation' => array(
								...
								'options' => array(
									'none' => esc_html__('None', 'tourmaster'),
									'navigation' => esc_html__('Only Navigation', 'tourmaster'),
									'bullet' => esc_html__('Only Bullet', 'tourmaster'),
									'both' => esc_html__('Both Navigation and Bullet', 'tourmaster'),
								),
								'default' => 'navigation',
								'condition' => array( 'tour-style' => array('modern', 'modern-no-space', 'grid', 'grid-with-frame', 'grid-no-space'), 'layout' => 'carousel' )
							),
...
jQuery(document).ready(function(){
	jQuery('#tourmaster-preview-tour-<?php echo esc_attr($id); ?>').parent()
