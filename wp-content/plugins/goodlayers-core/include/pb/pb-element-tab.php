	...
	jQuery('#gdlr-core-preview-accordion-<?php echo esc_attr($id); ?>').parent().gdlr_core_tab();
			...
			static function get_content( $settings = array(), $preview = false ){
				...
				if( !empty($settings['tabs']) ){
					$count = 0; $active = 1;
					$ret .= '<div id="tour-navbar" class="gdlr-core-tab-item-title-wrap clearfix gdlr-core-title-font" >';
					...
					$count = 0;
					$ret .= '<div id="tour-navbar-content" class="gdlr-core-tab-item-content-wrap clearfix" >';
					foreach( $settings['tabs'] as $tab ){ $count++;
						$ret .= '<div id="gdlr-core-tab-item-content"  class="gdlr-core-tab-item-content ' . ($count == $active? ' gdlr-core-active': '') . '" data-tab-id="' . esc_attr($count) . '" ' . gdlr_core_esc_style(array(
