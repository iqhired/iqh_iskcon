...
<!--      <h1>--><?php //echo QLWAPP_PLUGIN_NAME; ?><!-- <span style="font-size: 24px;color: #555;">v--><?php //echo QLWAPP_PLUGIN_VERSION; ?><!--</span></h1>-->
      <div class="about-text">
        <?php esc_html_e('Hello we\'re IQ Hired! We\'ve recently acquired this plugin and this is the first update. We have worked very much and very hard to release it, and we will do our absolute best to support it and fix all the issues.', 'wp-whatsapp-chat'); ?>
      </div>
    </div>
    <hr/>
